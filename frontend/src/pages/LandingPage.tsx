		...
		<div className="flex flex-col min-h-screen font-['Inter'] bg-gray-50 overflow-x-hidden">
			...
			<nav className="w-full h-16 bg-white shadow-sm flex items-center justify-between px-6 md:px-12 z-20">
				<div className="flex items-center gap-3">
					...
					<a
						href="https://github.com/47farhad/WT_PROJ_HMS"
						target="_blank"
			...
			<section className="relative pt-20 pb-16 md:pt-32 md:pb-24 px-6">
				<div className="max-w-4xl mx-auto text-center relative z-10">
					...
					>
						<motion.h1
							variants={fadeInUp}
							className="text-5xl md:text-7xl font-bold text-[#243954] mb-6 tracking-tight"
						>
						...
						>
							MedX is a full-stack academic project demonstrating
							role-based access control, real-time database
							management, and secure API architecture in a
							healthcare context.
						</motion.p>
					</motion.div>
				</div>
			...
			<section className="py-16 px-6 bg-white border-y border-gray-200">
				<div className="max-w-6xl mx-auto">
					<div className="text-center mb-12">
						<h2 className="text-3xl font-bold text-[#243954] mb-4">
							Explore the Platform
						</h2>
						<p className="text-gray-600">
							Select a role below to bypass login and instantly
							test the interfaces.
						</p>
					</div>
					...
					>
						{demoRoles.map((role) => (
							...
							>
								{role.icon}
								<h3 className="text-2xl font-bold text-[#243954] mb-3">
									{role.title}
								</h3>
				...
				<div className="max-w-6xl mx-auto">
					<div className="text-center mb-16">
						...
						<p className="text-blue-200">
							Built with modern web technologies and best
							practices.
						</p>
					</div>
					...
					<div className="grid grid-cols-1 md:grid-cols-3 gap-8">
						{techFeatures.map((tech, i) => (
							<div
								key={i}
								className="bg-[#2c4463] p-6 rounded-xl border border-[#3a5a82]"
							>
			...
			<footer className="bg-white py-12 px-6 border-t border-gray-200 mt-auto">
				<div className="max-w-6xl mx-auto flex flex-col md:flex-row justify-between items-center gap-6">
					<div className="flex items-center gap-2">
						<Logo size={24} />
						<span className="text-xl font-bold text-[#243954]">
							MedX
						</span>
					</div>
					...
					<div className="text-center md:text-right">
						...
						<p className="text-sm text-gray-500 mt-1">
							Developed by{" "}
							<a
								href="https://github.com/AyeshaArshad2203"
								target="_blank"
								rel="noopener noreferrer"
							...
							,{" "}
							<a
								href="https://github.com/47farhad"
								target="_blank"
								rel="noopener noreferrer"
								className="hover:underline text-gray-700"
							>
							...
							, and{" "}
							<a
								href="https://github.com/humna-26"
								target="_blank"
								rel="noopener noreferrer"
								className="hover:underline text-gray-700"
							>
